...
class Test_sql_loader(unittest.TestCase):
    ...
    def setUp(self):
        self.original_sql_folder = database.sql_loader.SQL_FOLDER_PATH
        database.sql_loader.SQL_FOLDER_PATH = "tests/database/"

    def tearDown(self):
        database.sql_loader.SQL_FOLDER_PATH = self.original_sql_folder
